...
public class ExtentListener implements ITestListener {
    ...
    public void configureReport() throws IOException {
        ...
        reports.setSystemInfo("browser:", ReadConfig.getConfigValue("browser"));
        reports.setSystemInfo("user name:", "Shashikanth Rajjoshi");
    ...
    public void onTestFailure(ITestResult Result) {
        ...
        try {
            base.captureScreenShot(BaseTest.driver, Result.getName());
        } catch (IOException e) {
            throw new RuntimeException(e);
        }
